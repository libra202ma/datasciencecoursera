...
## The main values in the data are calculated average of the mean and standard diviation of features.

* The mean values are for each subject doing each activity.
